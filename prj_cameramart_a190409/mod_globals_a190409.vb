Module mod_globals_a190409
    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_CAMERAMART_A190409.accdb;Persist Security Info=False;"
    Public myconnection2 As New OleDb.OleDbConnection(myconnection)
    Public myconnection3 As New OleDb.OleDbConnection(myconnection)
